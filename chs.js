...
var cnItems = {
    ...
    'Token Gain': '声望收益',
    'Value': '价值',
    'Zone Modifier Increase': '区域价值增加',
    'Zone Unlock Discount': '新区域解锁折扣',
    'Ok!': '好的！',
    'Decrease Circle Radius': '减小圆的半径',
    'Increase Cross Rotation': '增加交叉旋转速度',
    'Shrinks Zone Diamonds': '缩小区域方块尺寸',
    'Shrinks Ramp Width': '缩小坡道长度',
    'Confirm': '确认',
    'Saved!': '已保存!',
    'Increases Convayer Speed': '提高输送速度',
    'Increases Pusher Speed': '提高推杆速度',
    'Straightens Lines': '拉直线条',
    'Widens Channel': '加宽通道',
    '': '',
    '': '',
    '': '',
    ...
    'If the ball makes it to the bottom of the zone, it will earn its value modified by the zone\'s modifier.': '如果球到达区域的底部，它的价值将被区域的价值修改。',
